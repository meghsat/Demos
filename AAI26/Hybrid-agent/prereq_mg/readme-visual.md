...
## Your Workshop Workspace — read this first

Throughout the whole workshop you only ever work in **four places**. Every step below starts with a **colored band** that tells you exactly where to go next. Match the band to the surface and you'll never lose your place.

| Surface | What it's for |
|---------|---------------|
| **Browser (Chrome)** | The Fireworks key page, plus the vLLM SR and Lemonade Server dashboards |
| **Terminal 1 — Setup & Commands** | Start scripts, config changes, and one-off commands |
| **Terminal 2 — OpenClaw TUI** | The interactive agent chat (session `workshop`, later a new session `workshop2`) |
| **Terminal 3 — Tokenomics Monitor** | Live cost monitor — open once, then leave it running |

**The bands you'll see:**

![Switch to Browser]({{BANNER_URL}}/band-browser.png)

![Switch to Terminal]({{BANNER_URL}}/band-terminal.png)

![Open a new terminal tab]({{BANNER_URL}}/band-newtab.png)

![Inside the OpenClaw TUI]({{BANNER_URL}}/band-tui.png)

![Start a new OpenClaw session]({{BANNER_URL}}/band-newsession.png)

> **Rule of thumb:** You should end up with **one browser** and **at most three terminal tabs**. If you're about to open a fourth terminal, you almost certainly already have the tab you need — switch to it instead of opening a new one.
...
![Switch to Terminal]({{BANNER_URL}}/band-terminal.png)
**This is Terminal 1 — Setup & Commands. Steps 3, 4 and 6 all run here.**
...
![Switch to Terminal]({{BANNER_URL}}/band-terminal.png)
**Back in Terminal 1 — Setup & Commands.**
...
![Open a new terminal tab]({{BANNER_URL}}/band-newtab.png)
**This new tab becomes Terminal 2 — OpenClaw TUI. You'll keep coming back to this tab for the rest of the workshop.**
...
![Switch to Terminal]({{BANNER_URL}}/band-terminal.png)
**Go to Terminal 1 — Setup & Commands (not the TUI tab). Run the command below there.**
...
![Inside the OpenClaw TUI]({{BANNER_URL}}/band-tui.png)
**Switch back to Terminal 2 — OpenClaw TUI. Return to your running session, or restart it if needed.**
...
![Open a new terminal tab]({{BANNER_URL}}/band-newtab.png)
**This new tab becomes Terminal 3 — Tokenomics Monitor. Open it once and leave it running for the rest of the workshop.**
...
![Inside the OpenClaw TUI]({{BANNER_URL}}/band-tui.png)
**Switch back to Terminal 2 — OpenClaw TUI.**
...
![Switch to Terminal]({{BANNER_URL}}/band-terminal.png)
**Go to Terminal 1 — Setup & Commands (not the TUI tab).**
...
![Start a new OpenClaw session]({{BANNER_URL}}/band-newsession.png)
**In Terminal 2 — OpenClaw TUI, exit your current session and launch the new `workshop2` session below. This is a deliberately fresh session for the Startup Agent.**
...
![Inside the OpenClaw TUI]({{BANNER_URL}}/band-tui.png)
**Everything in this HR Admin section happens in Terminal 2 — OpenClaw TUI (session `workshop2`).**
...
![Inside the OpenClaw TUI]({{BANNER_URL}}/band-tui.png)
**This Benefits section stays in Terminal 2 — OpenClaw TUI.**
...
![Inside the OpenClaw TUI]({{BANNER_URL}}/band-tui.png)
**Still in Terminal 2 — OpenClaw TUI.**
...
![Inside the OpenClaw TUI]({{BANNER_URL}}/band-tui.png)
**Run this in Terminal 2 — OpenClaw TUI, and keep an eye on Terminal 3 — Tokenomics Monitor.**
